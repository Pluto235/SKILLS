...
```bash
python3 ~/.agents/skills/mineru-pdf-to-md/scripts/pdf_to_md.py /absolute/path/to/paper.pdf
```
...
```bash
python3 ~/.agents/skills/mineru-pdf-to-md/scripts/pdf_to_md.py paper.pdf
python3 ~/.agents/skills/mineru-pdf-to-md/scripts/pdf_to_md.py paper.pdf --output-dir ./mineru-output
python3 ~/.agents/skills/mineru-pdf-to-md/scripts/pdf_to_md.py scanned.pdf --method ocr
python3 ~/.agents/skills/mineru-pdf-to-md/scripts/pdf_to_md.py paper.pdf --fast
python3 ~/.agents/skills/mineru-pdf-to-md/scripts/pdf_to_md.py paper.pdf --start 0 --end 3
```
