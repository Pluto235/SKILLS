...
description: >-
  Create reproducible, cross-platform development environments with Flox for
  system packages, toolchains, local services, and team onboarding across macOS
  and Linux. Use when the user needs declarative project environments or
  mentions Flox, `.flox/`, `manifest.toml`, or `flox activate`.
origin: Flox
---
